...
const InnLeftSide = () => {
  return (
    <div className='w-[50%]'>
      ...
      <h2 className='text-xl cursor-pointer font-bold font-serif mt-8'>DevOps <BsArrowRight className='inline hover:translate-x-3 duration-300 text-3xl mx-6'></BsArrowRight></h2>
    </div>
  );
};
